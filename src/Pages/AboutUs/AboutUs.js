		...
		<div className="page about-us">
			<div className="about-us__content">
				...
				<p>
					...
					<br />
					As a people-centric company, every decision we make comes from our employees and stakeholders. We believe that our values are the DNA of our
					company because they are the DNA of our employees.
					<br />
					...
					<br />
					As our profits increase and our business expands, we are able to allocate more funds towards programming and partnerships that advocate for
					these causes at a hyperlocal level
					<br />
					...
					<br />
					The doctrines of Open Book Management help employees to understand this measure of success by using transparency and teaching to empower our
					employees to make financially intelligent decisions as stakeholders in our business.
					<br />
					...
					and harness strengths in employees, and we thereby attract employees who want to grow with the company. From day one, we allow our employees
					to play a role in creating a work environment that caters to their style of learning, interests and passions, and individual needs.
				</p>
			</div>
